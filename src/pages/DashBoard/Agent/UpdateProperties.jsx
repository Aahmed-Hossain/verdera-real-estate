...
const UpdateProperties = () => {
  ...
  const handleupdateProperty = async (e) => {
    ...
    console.log('update single ',   updateProperty);
    setLoading(true);
    const res = await axiosSecure.put(`/properties/addedProperties/${_id}`, updateProperty)
    setUploadImgText('Uploaded')
        console.log(res.data)
        setLoading(false)
        if(res.data.insertedId){
          Swal.fire('Great', "You have Updated Property Successfully", 'success') 
        }
  ...
  return (
    <div className="font-semibold">
      ...
      <div className="w-full min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl bg-gray-50 ">
        <form onSubmit={handleupdateProperty} className="w-10/12">
